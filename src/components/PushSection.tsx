...
import { Trash2, Edit2, Check, Plus, Image, Eye, MessageSquare, AlertCircle, GripVertical } from "lucide-react";
                ...
                return (
                  <tr 
                    ...
                    className={`transition-all duration-150 border-b ${
                      ...
                      isOver ? "bg-cyan-50 border-t-2 border-b-2 border-t-cyan-500 border-b-cyan-500" : "border-slate-100"
                    }`}
                  >
                    {/* Drag Handle */}
                    <td className="px-2 py-3 text-center align-middle">
                      <div 
                        ...
                        title={isEditing ? "Save editing to drag row" : "Drag to reorder push campaign"}
                      >
